                ...
                Home
                  ...
                  >
                    ...
                    <ul className="submenu">
                      ...
                      <li
                        className={
                          pathnames.includes("Pharmacy-details") ? "active" : ""
                        }
                      >
                      ...
                      <li
                        className={
                          pathnames.includes("pharmacy-search") ? "active" : ""
                        }
                      >
                      ...
                      <li
                        className={
                          pathnames.includes("product-checkout") ? "active" : ""
                        }
                      >
                      ...
                      <li
                        className={
                          pathnames.includes("payment-success") ? "active" : ""
                        }
                      >
